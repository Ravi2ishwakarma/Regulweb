    ...
    <header className="fixed left-0 top-0 z-50 w-full border-b border-[var(--border-color)] bg-[var(--bg-primary)]/80 backdrop-blur-xl">
      ...
      <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          <Link to="/" className="flex items-center">
            <img
              ...
              alt="REGUL"
              className="hidden fixed left-20 h-15 min-[1025px]:block w-auto"
            />

            <img
              src={ mode === "dark" ? whiteLogo: blackLogo}
              alt="REGUL"
              className="block h-15 min-[1025px]:hidden  w-auto"
            />
        ...
        <div className="hidden items-center gap-4 lg:flex">
          ...
          <Link
            to="/contact"
            className="flex items-center rounded-full  bg-[var(--accent)] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[var(--accent-hover)] hover:shadow-lg hover:shadow-[var(--accent)]/20"
          >
            Book Consultation
            <FiArrowUpRight />
          </Link>
