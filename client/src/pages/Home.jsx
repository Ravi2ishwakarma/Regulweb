          ...
          <Reveal delay={0.2}>
            <div className="relative flex min-h-[500px] items-center justify-center">
              ...
              <motion.div
                ...
                className="relative flex  h-72 w-72 justify-center items-center rounded-[40px] border border-blue-400/30 bg-gradient-to-br from-blue-400/30 to-purple-400/10 shadow-[0_0_100px_rgba(37,99,235,0.35)] backdrop-blur-xl"
              >
                <div className="text-2xl text-white/90 ">
                  <img src={ mode === "dark" ? whiteLogo : blackLogo} alt="logo" className="theme-logo h-60 rounded-2xl opacity-50" />
                </div>
      ...
      <section className="px-6 py-15">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-20 grid gap-6 md:grid-cols-3">
            ...
            {[
              ["Mission", "To build reliable, user-focused software and digital products through innovation, quality, collaboration, and continuous improvement while creating lasting value for every client."],
              ["Vision", "To become a trusted technology partner by delivering innovative digital solutions that empower businesses to grow, transform, and succeed in a rapidly evolving world globally."],
              ["Values", "We Believe in integrity, innovation, quality, teamwork, customer satisfaction, and continuous learning to deliver reliable solutions, build long-term relationships based on trust."],
             ].map(([title, text], index) => (
              <Reveal delay={index * 0.1} key={title}>
                <div className="glass rounded-3xl p-8 transition hover:-translate-y-2 hover:border-blue-500/40">
