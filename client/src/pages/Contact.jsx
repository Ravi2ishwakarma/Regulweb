    ...
    <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
      ...
      >
        ...
        {[
          ...
          <div key={name} className="mb-4">
            ...
            <input
              ...
              className={`w-full theme-input opacity-60 rounded-xl border bg-white/5 px-5 py-4 outline-none transition focus:border-blue-500 ${errors[name]
                ? "border-red-500"
                : "border-white/10"
                }`}
            />
        ...
        <select
          ...
          value={form.service}
          onChange={handleChange}
          className={`mb-1 w-full opacity-60 theme-input rounded-xl border bg-white/5 px-5 py-4 text-gray-400 outline-none focus:border-blue-500 ${errors.service
            ? "border-red-500"
            : "border-white/10"
            }`}
        >
        ...
        <textarea
          ...
          rows="6"
          className={`mb-1 w-full theme-input opacity-60 rounded-xl border bg-white/5 px-5 py-4 outline-none focus:border-blue-500 ${errors.message
            ? "border-red-500"
            : "border-white/10"
            }`}
        />
