    ...
    <header className="fixed left-0 top-0 z-50 w-full border-b border-[var(--border-color)] bg-[var(--bg-primary)]/80 backdrop-blur-xl">
      ...
      <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--accent)] text-xl font-bold text-white shadow-lg shadow-[var(--accent)]/20">
            R
          </div>

          <div className="hidden sm:block">
            <p className="text-lg font-bold tracking-[0.2em] text-[var(--text-primary)]">
              REGUL
            </p>
        ...
        <div className="hidden items-center gap-4 lg:flex">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="flex h-10 items-center gap-2 rounded-full border border-[var(--border-color)] bg-[var(--bg-secondary)] px-3 text-[var(--text-primary)] transition hover:scale-105"
          ...
          <Link
            to="/contact"
            className="flex items-center gap-2 rounded-full bg-[var(--accent)] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[var(--accent-hover)] hover:shadow-lg hover:shadow-[var(--accent)]/20"
          >
            Book Consultation
            <FiArrowUpRight />
          </Link>
      ...
      <div
        className={`overflow-hidden border-t border-[var(--border-color)] bg-[var(--bg-primary)]/95 backdrop-blur-xl transition-all duration-300 lg:hidden ${
          isOpen
