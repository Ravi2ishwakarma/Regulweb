    ...
    <div className="overflow-hidden">
          ...
          <Reveal delay={0.2}>
            <div className="relative flex min-h-[500px] items-center justify-center">
              ...
              <motion.div
                ...
                className="relative flex h-72 w-72 items-center justify-center rounded-[40px] border border-blue-400/30 bg-gradient-to-br from-blue-600/30 to-purple-600/10 shadow-[0_0_100px_rgba(37,99,235,0.35)] backdrop-blur-xl"
              >
                <div className="text-8xl rounded-full font-black text-white/90 opacity-35">
                  <img src="Public/regullogo.jpeg" alt="logo" className="rounded-full" />
                </div>
      ...
      <section className="px-6 py-32">
        <div className="mx-auto max-w-7xl">
          ...
          <Reveal>
            <p className="mb-4 theme-color text-sm uppercase tracking-[0.3em] text-blue-400">
              Who We Are
            </p>
      ...
      {/* SERVICES */}
      <section id="services" className="bg-white/[0.02] px-6 py-32">
        <div className="mx-auto max-w-7xl">
